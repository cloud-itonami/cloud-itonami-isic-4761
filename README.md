...
- `test/bookstoreops/governor_test.cljk` -- unit tests of governor hard
  checks, scope exclusion, and the self-trip regression test
- `test/bookstoreops/advisor_test.cljk` -- advisor proposal shape and
  consistency
- `test/bookstoreops/phase_test.cljk` -- rollout phase logic
- `test/bookstoreops/governor_contract_test.cljk` -- full graph
  integration, audit trail
- `test/bookstoreops/store_contract_test.cljk` -- Store protocol and
