...
1. Register operator, stores and vendors; independently confirm each
   store's business registration and each vendor's (publisher/
   distributor) registration before seeding `bookstoreops.store`.
...
and human review for every escalation-gated action -- including any
return/refund finalization and any content-inclusion/exclusion editorial
decision, both of which remain outside this actor's authority entirely.
